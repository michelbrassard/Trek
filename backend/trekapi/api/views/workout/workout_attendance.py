from api.models import Workout, WorkoutAttendance, Competition, CompetitionAttendance
from rest_framework.decorators import api_view, permission_classes
from rest_framework.permissions import IsAuthenticated
from django.contrib.auth import get_user_model
from rest_framework.response import Response
from api.serializers import WorkoutWithAttendeesSerializer, CurrentWorkoutAttendeesSerializer, CompetitionWithAttendeesSerializer, CurrentCompetitionAttendeesSerializer
...
def current_workout_attendance(request, workout_id):
    if request.method == 'GET':
        try:
            ...
            serializer = CurrentWorkoutAttendeesSerializer(currentAttendance, many=True)
