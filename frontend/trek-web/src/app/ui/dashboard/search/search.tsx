    ...
    return(
        <div className="md:relative md:w-fit">
            ...
            <AnimatePresence>
                {searchedTerm && (
                    <motion.div
                        className="backdrop-blur-md bg-neutral-100/60 dark:bg-neutral-900/60 w-[70%] absolute z-20 right-0 md:w-[600px] h-[400px] border border-neutral-200 dark:border-neutral-800 rounded-2xl mx-2 py-3 px-3 overflow-scroll"
