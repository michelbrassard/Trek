    ...
    return(
        <button 
            className={clsx(isDesktop ? 
                "border border-opacity-0 dark:border-opacity-0 rounded-xl transition-all flex items-center gap-2 py-2 px-4 hover:text-red-500 border-red-400 dark:border-red-600 hover:border-opacity-100" 
                : 
