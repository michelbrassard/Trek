interface OutlinedTrekLogoProps {
    size: number,
    strokeColor: string,
    strokeWidth: number
}

export default function TrekLogo({size, strokeColor, strokeWidth}: OutlinedTrekLogoProps) {
    return(
        <div className="flex">
            <svg 
                width={size}
                ...
                className={`w-full h-auto stroke-${strokeColor} stroke-[${strokeWidth}] fill-none`}
